...
import { FaCheckCircle, FaCalendarAlt, FaMapMarkerAlt, FaUsers, FaTicketAlt } from 'react-icons/fa';
  ...
  return (
    <div className="container mx-auto px-4 py-16 max-w-4xl">
      <div className="bg-green-50 border border-green-200 rounded-lg p-8 mb-8 text-center">
        ...
        <p className="text-lg text-green-600 mb-4">Tu reserva ha sido procesada correctamente.</p>
        <p className="text-gray-600">Hemos enviado un correo electrónico con los detalles de tu reserva.</p>
      </div>
          ...
          <div className="bg-gray-50 p-4 rounded-lg mb-6">
            ...
            <div className="inline-block px-3 py-1 rounded-full text-sm font-semibold bg-green-100 text-green-800">
              {reserva.estado === 'confirmada' ? 'Confirmada' : 
               reserva.estado === 'pendiente' ? 'Pendiente de confirmación' : 'Cancelada'}
            </div>
          </div>
        </div>
      </div>
