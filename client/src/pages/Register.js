...
const Register = () => {
  ...
  const handleGoogleRegistration = async () => {
    try {
      await login();
      toast.success('¡Registro exitoso! Bienvenido a Crepes & Coffee');
      navigate('/registro-exitoso', { replace: true });
    } catch (error) {
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-sm text-gray-600">
          Regístrate para disfrutar de nuestros productos y servicios
        </p>
      </div>
          ...
          <div className="mb-8">
            <div className="text-center">
              <div className="w-16 h-16 bg-amber-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <i className="fas fa-user-plus text-2xl text-amber-700"></i>
              </div>
              <h3 className="text-lg font-semibold text-gray-900 mb-2">
                ¡Únete a nuestra comunidad!
              </h3>
              <p className="text-gray-600 text-sm">
                Crea tu cuenta con Google para comenzar
              </p>
            </div>
          </div>
